...
#define NRF_OPT_DEFAULT_MDM_TRACES 23 /* NRF_IPERF3_INTEGRATION_CHANGE: added */
...
int nrf_iperf3_mock_getsockdomain(struct iperf_test *test, int sock); /* NRF_IPERF3_INTEGRATION_CHANGE: added */
